...
if __name__ == "__main__":
    ...
    input_path = 'D:/steve/random stuff/Terrebone/FHR/charts/CollatedCharts_173443.csv'
    root_dir = 'D:/steve/random stuff/Terrebone/FHR/charts/'
    create_dir(root_dir)
    ...
    with open(input_path) as file:
        ...
        for i, line in enumerate(reader):
            ...
            pdf_name = line[1]
            print(f"Processing Ref: [{i+1}/{counter_total_refs}] Success: [{counter_success}] \t Patient: [{patient_name}]")
