...
dir_result = 'D:/steve/random stuff/Terrebone/FHR/result/'
file_input = 'D:/steve/random stuff/Terrebone/FHR/code/input.xlsx'

base_url = 'https://ats.medtronsoftware.com/login/login'
